...
class ArticleController extends HomeBaseController
{
    public function index()
    {
        ...
        if (!empty($type)) {
            if (isset($article)){
                $_article['title'] = $article->post_title;
                $_article['source'] = $article->post_source;
                $_article['content'] = $article->post_content;
                $_article['time'] = date("Y-m-d H:i:s",$article->published_time);
